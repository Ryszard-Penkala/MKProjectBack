...
export class AdRecord implements AdEntity {
    ...
    constructor(obj: NewAdEntity) {
        if (!obj.name || obj.name.length > 100){
            throw new ValidationError('Nazwa ogłoszenia nie może być pusta, ani nie może przekraczać 100 znaków.')
        }
        ...
        if (!obj.url || obj.url.length > 100){
            throw new ValidationError('Link ogłoszenia nie może być pusty, ani nie może przekraczać 100 znaków.')
        }
    ...
    static async findAll(name: string | null): Promise<SimpleAddEntity[]> {
