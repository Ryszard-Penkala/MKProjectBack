...
test('AdRecord.getOne returns null for unexisting entry', async ()=>{
...
test('AdRecord.findAll returns empty array when searching for something that is not existing.', async ()=>{
    const ads = await AdRecord.findAll('-------------------');
